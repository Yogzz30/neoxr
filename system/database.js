module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'ChinoBotz'
      if (!('sk_author' in setting)) setting.sk_author = 'By YogzzDevX'
      ...
      if (!('owners' in setting)) setting.owners = ['6285852129763','6285807405071']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = '*Halloo +tag 💐*\n_I am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp._\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Website YogzzDevX:* https://s.id/YogzzDevX\n◦ *Website ChinoBotz:* https://chinobotz.my.id\n\n_If you find an error or want to upgrade premium plan contact the owner._'
      if (!isNumber(setting.menuStyle)) setting.menuStyle = 4
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/52528084fd70b2d85affe.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/LYC14O9y4PoF3ondOF7aoU'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6285852129763','6285807405071'],
         lastReset: new Date * 1,
         msg: '*Halloo +tag 💐*\n_I am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp._\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Website YogzzDevX:* https://s.id/YogzzDevX\n◦ *Website ChinoBotz:* https://chinobotz.my.id\n\n_If you find an error or want to upgrade premium plan contact the owner._',
         menuStyle: 4,
         cover: 'https://telegra.ph/file/52528084fd70b2d85affe.jpg',
         link: 'https://chat.whatsapp.com/LYC14O9y4PoF3ondOF7aoU'
      }
   }
}